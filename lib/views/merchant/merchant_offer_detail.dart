...
import 'package:mizaa/models/offers/offer_images/OfferImages.dart';
...
import 'package:mizaa/views/merchant/merchant_ratings.dart';
import 'package:mizaa/views/offer/offer_terms_conditions.dart';
import 'package:mizaa/views/offer/widget/expanded_card.dart';
import 'package:mizaa/views/widgets/shimmer_container.dart';
import 'package:mizaa/views/widgets/build_button_with_icon.dart';
...
class MerchantOfferDetail extends GetView<OfferController> {
  final OfferModel offerModel;
  MerchantOfferDetail({Key? key, required this.offerModel}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    controller.resetMerchantOfferDetailScrolling();
    controller.checkIfUserRatedBefore(
        offerKey: offerModel.key!, offerId: offerModel.id!);
    ...
    return Obx(
      () => WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: controller.appBarMerchantOfferDetailColor.value,
            flexibleSpace: AnnotatedRegion<SystemUiOverlayStyle>(
                value: SystemUiOverlayStyle(
                  statusBarColor: Colors.transparent,
                  statusBarIconBrightness:
                      controller.appBarMerchantOfferDetailColor.value ==
                              Colors.white
                          ? Brightness.dark
                          : Brightness.light,
                  statusBarBrightness:
            ...
            actions: [
              ...
              appBarIcon(
                  ...
                  icon: Icons.share,
                  iconColor:
                      controller.appBarItemMerchantOfferDetailColor.value,
          ...
          body: ListView(
              controller: controller.scrollMerchantOfferDetailController,
