...
class SortedByIcon extends StatelessWidget {
  ...
  const SortedByIcon({Key? key,required this.sortedByOnPressed,}) : super(key: key);
            ...
            Row(
              children: [
                ...
                Text(
                  ...
                  style:
                  TextStyle(color: Get.isDarkMode? Colors.white: ColorConstants.greyColor, fontSize: 13),
                ),
              ],
            ),
            Icon(
