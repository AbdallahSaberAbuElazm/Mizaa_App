...
class _WalletButtonsState extends State<WalletButtons> {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        _buildButton(btnName: translation.all.tr, number: 0, typeOfList: 'all'),
        const SizedBox(
          width: 10,
        ),
        _buildButton(
            btnName: translation.income.tr, number: 1, typeOfList: 'income'),
        const SizedBox(
          width: 10,
        ),
        _buildButton(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: Get.isDarkMode
                      ? Colors.white
                      : (Controllers
                                  .userAuthenticationController.btnName.value ==
                              btnName)
                          ? Colors.white
            ...
            onTap: () {
              setState(() {
                Controllers.userAuthenticationController
                    .setBtnNameAndNum(name: btnName, number: number);
