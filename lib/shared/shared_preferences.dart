...
class SharedPreferencesClass {
  ...
  static setUserData({required UserLoginData userLoginData}) async {
    ...
    await _sharedPreferences!
        .setString('phoneNumber', userLoginData.phoneNumber);
  ...
  static setUserBasicInfo({required UserBasicInfo userBasicInfo}) async {
    await _sharedPreferences!
        .setString('applicationUserId', userBasicInfo.applicationUserId);
    await _sharedPreferences!
        .setString('balance', userBasicInfo.balance.toString());
    await _sharedPreferences!
        .setString('points', userBasicInfo.points.toString());
    await _sharedPreferences!.setString('firstName', userBasicInfo.name);
    await _sharedPreferences!.setString('phoneNumber', userBasicInfo.mobile);
  }
  ...
  static removeDataForLogout() async {
    ...
    await _sharedPreferences!.remove('applicationUserId');
    await _sharedPreferences!.remove('balance');
    await _sharedPreferences!.remove('points');
  }

  static String? getUserId() => _sharedPreferences!.getString('userId');
  static String? getPhoneNumber() =>
      _sharedPreferences!.getString('phoneNumber');
  ...
  static String? getApplicationUserId() =>
      _sharedPreferences!.getString('applicationUserId');
  ...
  static String? getLanguageCode() =>
      _sharedPreferences!.getString('languageCode');
